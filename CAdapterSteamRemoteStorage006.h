class CAdapterSteamRemoteStorage006
{
	...
	virtual unknown_ret PublishVideo( char const*, char const*, uint32, char const*, char const*, ERemoteStoragePublishedFileVisibility, SteamParamStringArray_t * ) = 0;
