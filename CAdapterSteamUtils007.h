class CAdapterSteamUtils007
{
	...
	virtual unknown_ret ShowGamepadTextInput( EGamepadTextInputMode, EGamepadTextInputLineMode, char const*, uint32, char const* ) = 0;
	virtual unknown_ret GetEnteredGamepadTextLength() = 0;
	virtual unknown_ret GetEnteredGamepadTextInput( char *, uint32 ) = 0;
