class CSteamInterface006
{
	...
	virtual unknown_ret OpenFileEx( char const*, char const*, int32, uint32 *, int32 *, TSteamError * ) = 0;
	...
	virtual unknown_ret IsFileNeededByApp( uint32, char const*, uint32, uint32 *, TSteamError * ) = 0;
	virtual unknown_ret WaitForAppResources( uint32, char const*, TSteamError * ) = 0;
	...
	virtual unknown_ret GetDepotParent( uint32, uint32 *, TSteamError * ) = 0;
	virtual unknown_ret GetCurrentCellID( uint32 *, uint32 *, TSteamError * ) = 0;
	virtual unknown_ret ForceProcessLocalEngine() = 0;
	virtual unknown_ret SetUser2( char const*, TSteamError * ) = 0;
};
