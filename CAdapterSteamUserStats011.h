class CAdapterSteamUserStats011
{
	...
	virtual unknown_ret GetAchievementName( uint32 ) = 0;
	...
	virtual unknown_ret GetGlobalStat( char const*, int64 * ) = 0;
	virtual unknown_ret GetGlobalStat( char const*, double * ) = 0;
	virtual unknown_ret GetGlobalStatHistory( char const*, int64 *, uint32 ) = 0;
	virtual unknown_ret GetGlobalStatHistory( char const*, double *, uint32 ) = 0;
};
